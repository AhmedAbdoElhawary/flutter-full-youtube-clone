...
class _PodProgressBarState extends State<PodProgressBar> {
  late final podCtr = Get.find<PodGetXVideoController>(tag: widget.tag);
  late VideoPlayerValue? videoPlayerValue = podCtr.videoCtr?.value;
...
class _ProgressBarPainter extends CustomPainter {
  _ProgressBarPainter(this.value,
      {this.podProgressBarConfig, required this.isOverlayVisible});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double circleHandlerRadius =
        isOverlayVisible ? podProgressBarConfig!.circleHandlerRadius : 0;
    ...
    Color playingBarColor = podProgressBarConfig!.playingBarColor;
